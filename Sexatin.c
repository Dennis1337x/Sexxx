...
{
        if(argc < 6){
                fprintf(stderr, "Yanlis Kullanim OC!\n");
                fprintf(stdout, "Aha Boyle Kullancan: %s ipyigirkrdsm <porno- pardon port buraya> <saniyelik vurus hizi> -1 vuracagi sure\n", argv[0]);
                exit(-1);
        }
 
        fprintf(stdout, "Kuruyom amk salagi bekle\n");
